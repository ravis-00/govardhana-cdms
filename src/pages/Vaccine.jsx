                  ...
                  >
                    ...
                    <td style={{ ...tdStyle, textAlign: "center" }}>
                      <div style={{ display: "flex", gap: "5px", justifyContent: "center" }}>
                        <button onClick={() => setSelectedEntry(row)} style={iconBtnStyle}>
                          👁️
                        </button>
                        <button onClick={() => openFormForEdit(row)} style={iconBtnStyle}>
                          ✏️
                        </button>
                      </div>
                    </td>
      ...
      {showForm && (
        <div style={overlayStyle} onClick={() => setShowForm(false)}>
          <div style={modalStyle} onClick={(e) => e.stopPropagation()}>
            <h2 style={{ margin: "0 0 1rem 0", fontSize: "1.2rem", color: "#111827" }}>
              {isEditMode ? "Edit" : "Add"} Entry
            </h2>
            ...
            <form onSubmit={handleSubmit} style={{ display: "grid", gap: "1rem" }}>
              ...
              <Field label="Target Group">
                <input
                  ...
                  onChange={handleChange}
                  className="form-input"
                  placeholder="e.g. All Cows, Calves Only"
                />
              </Field>
        ...
        <div style={overlayStyle} onClick={() => setSelectedEntry(null)}>
          <div style={modalStyle} onClick={(e) => e.stopPropagation()}>
            ...
            >
              ...
              <DetailItem
                label="Next Due Date"
                value={formatDisplayDate(selectedEntry.nextDueDate)}
